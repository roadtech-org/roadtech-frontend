...
import { Card, CardHeader, CardTitle, CardContent, Badge, Button } from '../common';
import { User, Mail, Phone, CheckCircle, XCircle, Wrench, Package, MapPin } from 'lucide-react';
...
export function VerificationTab() {
  ...
  const verifyMechanicMutation = useMutation({
    mutationFn: (id: number) => adminApi.verifyMechanic(id),
    onSuccess: () => {
  ...
  const verifyProviderMutation = useMutation({
    mutationFn: (id: number) => adminApi.verifyProvider(id),
    onSuccess: () => {
