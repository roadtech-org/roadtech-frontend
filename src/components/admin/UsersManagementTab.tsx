...
import { Card, CardHeader, CardTitle, CardContent, Badge, Button, Input, Select } from '../common';
import { User, Mail, Phone, ToggleLeft, ToggleRight, Trash2, Search } from 'lucide-react';
...
const roleColors: Record<UserRole, 'default' | 'info' | 'warning' | 'success' | 'danger'> = {
  USER: 'default',
  MECHANIC: 'info',
                ...
                >
                  <div className="flex items-center space-x-4 flex-1">
                    <div className={`h-12 w-12 rounded-full flex items-center justify-center ${
                      ...
                      <User className={`h-6 w-6 ${user.isActive ? 'text-blue-600' : 'text-gray-400'}`} />
                    </div>
