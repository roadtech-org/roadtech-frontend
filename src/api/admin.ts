...
export const adminApi = {
  ...
  verifyMechanic: async (id: number, notes?: string) => {
    const response = await apiClient.put(`/admin/mechanics/${id}/verify`, { notes });
    return response.data;
  },
  ...
  verifyProvider: async (id: number, notes?: string) => {
    const response = await apiClient.put(`/admin/parts-providers/${id}/verify`, { notes });
    return response.data;
  },
